...
- 🤖 **AI Agent Enthusiast** – I am interested in building AI agents that can reason, use tools, retrieve knowledge, and assist users in real-world tasks.  
- 🔎 **RAG & LLM Application Learner** – I enjoy developing Retrieval-Augmented Generation systems that connect Large Language Models with documents, databases, and external tools.  
- 💻 **Data-Driven Problem Solver** – I use data science, machine learning, and AI workflows to analyze problems and create practical solutions.  
- 🧩 **Project-Focused Mindset** – I have experience working on AI-based projects such as RAG chatbots, talk-to-dashboard systems, computer vision models, and intelligent automation tools.  
- ⚙️ **Backend & AI Integration** – I am interested in connecting AI models with backend systems, APIs, vector databases, and user-facing applications.  
- ✨ **Beyond AI** – I enjoy learning new AI techniques, exploring agent frameworks, experimenting with automation tools, and following modern technology trends.  
...
![LlamaIndex](https://img.shields.io/badge/LlamaIndex-4B0082?style=for-the-badge&logo=llama&logoColor=white)
